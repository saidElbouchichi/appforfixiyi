...
export default function LoginPage(): React.JSX.Element {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-6 p-8">
      <h1 className="text-2xl font-semibold text-[var(--fixiyi-color-neutral-900)]">Fixiyi Admin</h1>
      ...
      {step === "phone" ? (
        ...
        >
          <label className="text-sm text-[var(--fixiyi-color-neutral-600)]" htmlFor="phone">
            Numero de telephone (E.164, ex. +212612345678)
          </label>
          <input
            id="phone"
            type="tel"
        ...
        >
          {devCode ? (
            <p className="rounded bg-[var(--fixiyi-color-primary-100)] px-3 py-2 text-sm text-[var(--fixiyi-color-primary-700)]">
